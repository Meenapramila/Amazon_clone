...
//      <div class="js-order-container"></div>
//      <div class="js-payment-container"></div>
...
//    expect(
//      document.querySelector(`.js-product-quantity-${productId1}`).innerText).toContain('2');
//    expect(
//      document.querySelector(`.js-product-quantity-${productId2}`).innerText).toContain('1');
